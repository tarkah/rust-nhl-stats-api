...
pub trait TeamsApi {
    fn get_team(&self, id: f32, expand: &str, season: &str) -> Result<crate::models::Team, Error>;
    fn get_team_roster(&self, id: f32, season: &str) -> Result<crate::models::Rosters, Error>;
