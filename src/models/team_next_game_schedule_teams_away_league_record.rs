...
pub struct TeamNextGameScheduleTeamsAwayLeagueRecord {
...
impl TeamNextGameScheduleTeamsAwayLeagueRecord {
    pub fn new() -> TeamNextGameScheduleTeamsAwayLeagueRecord {
